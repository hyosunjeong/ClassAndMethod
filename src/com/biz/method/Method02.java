...
public class Method02 {
	...
	// 값을 전달하고, 그 결과를 반드시 main에게 보고하는 method를 선언
	...
	public static int addVarReturn(int intNum1, int intNum2) {
		 ...
		 * method를 호출(사용)한 곳으로 메시지를 전달하는 용도로 사용할 수 있다.
		 */
		// return 0;
		return intSum;
		// 두개의 정수형 매개변수 값을 전달 받은 후 
		// 덧셈한 결과가 담긴 intSum 변수를 return문과 함께 작성하므로 해서
		// intSum에 보관되어 있는 intNum1+intNum2의 결과를 호출한 곳으로 메시지로 전달한다.
